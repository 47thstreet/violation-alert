...
export default function ViolationsError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4">
      ...
      <h2 className="text-xl font-bold text-gray-900 mb-2">Failed to load violations</h2>
      <p className="text-sm text-gray-500 mb-6 text-center max-w-md">
        We could not fetch violation data. The NYC Open Data APIs may be temporarily unavailable.
      </p>
