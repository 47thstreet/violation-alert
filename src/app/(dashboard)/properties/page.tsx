    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
        ...
        {canAdd ? (
          <Link
            href="/properties/new"
            className="bg-red-600 text-white px-4 py-2.5 rounded-lg font-medium hover:bg-red-700 active:scale-[0.98] transition-all min-h-[44px] flex items-center shrink-0"
          >
            Add Property
          </Link>
        ) : (
